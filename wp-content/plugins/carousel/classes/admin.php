<?php
if ( !class_exists( "pluginbuddy_carousel_admin" ) ) {
    class pluginbuddy_carousel_admin {
	
		function pluginbuddy_carousel_admin(&$parent) {
			$this->_parent = &$parent;
        ...
        */
        function add_media_gallery_strings( $strings ) { 
            $strings['itMediaLibraryAddImageTitle'] = __( 'Add an Image', 'it-l10n-carousel' );
            $strings['setITMediaLibraryAddImage']   = __( 'Add image', 'it-l10n-carousel' );
            return $strings;
        } 

    } // End class
	
	$pluginbuddy_carousel_admin = new pluginbuddy_carousel_admin($this); // Create instance
}
